...
import session.UsersGroupsFacade;
...
public class UsersGroupsController implements Serializable {
    ...
    @EJB
    private session.UsersGroupsFacade ejbFacade;
    ...
    public String create(UsersGroups uG) {
        try {
            ...
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured") + " with User Group | " + e.getMessage());
            return null;
        }
